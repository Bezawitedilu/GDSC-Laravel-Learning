...
<head>
    ...
    <title>Welcome to Bezawit's Blog</title>
...
<nav class="bg-indigo-600 p-4">
    <div class="container mx-auto flex justify-between items-center">
        <h1 class="text-white text-2xl font-semibold">Bezawit's Blog</h1>
        <div class="flex space-x-4">
            <a href="auth/login.php" class="text-white">Login</a>
            <a href="auth/signup.php" class="text-white">Signup</a>
        </div>
    </div>
</nav>
